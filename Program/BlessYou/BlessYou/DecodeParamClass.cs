...
// 2015-03-18/GF    DecodeParam: Added detect of "addx" and new out param: o_InteractionIsOn
//
...
namespace BlessYou
{
    public static class DecodeParamClass
    {
        ...
        public static void DecodeParam(string[] i_Param, out List<SoundFileClass> o_FileNameList, out string o_NewProblemFileName, out string o_FtrFilePath, out bool o_InteractionIsOn)
        {
            string samplesFileName;
            string tempStr;

            o_InteractionIsOn = false;
            ...
            else
            {
                tempStr = "Usage:\n" +
                                 ...
                                 "     File name for new problem | \"allx\" : all files in Case Library run in sequence + interactiev dialogue\n" +
                ...
                throw new System.Exception(tempStr);                // Set i Project Properties -> Debug: command line params.
                                                                    ...
                                                                    //    ..\..\..\samplesFileNames-all.txt allx            (as "All" but with dialogue after!)
            ...
            o_InteractionIsOn = "allx" == o_NewProblemFileName.ToLower();

            if (("all" == o_NewProblemFileName.ToLower())
                    |
                 ("allx" == o_NewProblemFileName.ToLower()))
            {
