...
namespace BlessYou
{
    ...
    public class WaveFileClass
    {
        ...
        public void AnalyseWaveFileContents()
        {
            ...
            {
                VirtualConsoleStaticClass.WriteLine(String.Format(
                                  "{0, 4:0} - Tot: {1, 6:0}ms IBeg: {2, 6:0}ms Trigg: {3, 6:0}ms IEnd: {4, 6:0}ms IntAll: {5, 5:0}ms Int: {6, 5:0}ms {7, 8:0} = {8, 2:0}%, of whole: {9, 3:0}%, {10}",
                                  FOrderNr,
                                  WaveFileLengthInMilliSecs,
                                  FStartOfFirstIntervalIx / ConfigurationStatClass.C_SOUND_SAMPLE_FREQUENCY_IN_kHz,
                                  FTrigPositionIx / ConfigurationStatClass.C_SOUND_SAMPLE_FREQUENCY_IN_kHz,
